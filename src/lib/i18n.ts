...
export const dictionaries = {
  en: {
    ...
    home: {
      ...
      heroNote: "Gray flags are still alive. Full-color flags are admitted. The paperwork updates as teams fall.",
      latestBurials: "Latest Burials",
      viewLatest: "View Latest Burials",
      earlyAdmission: "Early Admission",
      featuredBadge: "Latest Admission",
      featuredTitle: "Latest arrival: {team}",
      featuredFallbackEpitaph: "The final whistle has filed the paperwork.",
      paperwork: "Build the paperwork",
      wallTitle: "The Wall of the Living and the Fallen",
      wallBody: "{alive} teams are still breathing. {fallen} have entered the Funeral Home.",
      openFeed: "Open Feed",
      emptyLatest: "No burials yet. The paperwork is open for the fallen.",
    },
    teamCard: {
      earlyAdmission: "Early Admission",
    ...
    create: {
      ...
      description: "Create a shareable World Cup Funeral Home tombstone for eliminated World Cup teams.",
    ...
    feed: {
      ...
      emptyBody: "Be the first fan to make the paperwork public.",
    },
    detail: {
      ...
      teamStats: "Team-wide mourning stats",
  ...
  es: {
    ...
    home: {
      ...
      heroNote: "Las banderas grises siguen vivas. Las de color ya fueron admitidas. El papeleo se actualiza cuando caen selecciones.",
      latestBurials: "Últimos entierros",
      viewLatest: "Ver últimos entierros",
      earlyAdmission: "Ingreso anticipado",
      featuredBadge: "Último ingreso",
      featuredTitle: "Última llegada: {team}",
      featuredFallbackEpitaph: "El pitido final ya presentó el papeleo.",
      paperwork: "Preparar el papeleo",
      wallTitle: "El muro de vivos y caídos",
      wallBody: "{alive} selecciones siguen respirando. {fallen} ya entraron a la funeraria.",
      openFeed: "Abrir tablón",
      emptyLatest: "Aún no hay entierros. El papeleo está abierto para las caídas.",
    },
    teamCard: {
      earlyAdmission: "Ingreso anticipado",
    ...
    create: {
      title: "Crear lápida",
      description: "Crea una lápida compartible para selecciones eliminadas del Mundial.",
    ...
    feed: {
      ...
      emptyBody: "Sé el primer hincha en publicar el papeleo.",
    },
    detail: {
      ...
      teamStats: "Estadísticas de duelo del equipo",
  ...
  zh: {
    ...
    home: {
      ...
      heroNote: "灰色旗帜还活着。彩色旗帜已经入馆。球队倒下时，手续会继续更新。",
      latestBurials: "最新下葬",
      viewLatest: "查看最新下葬",
      earlyAdmission: "提前入住",
      featuredBadge: "最新入馆",
      featuredTitle: "最新到达：{team}",
      featuredFallbackEpitaph: "终场哨已经把手续递上来了。",
      paperwork: "办理手续",
      wallTitle: "生者与倒下者之墙",
      wallBody: "{alive} 支球队还在喘气。{fallen} 支已经进入殡仪馆。",
      openFeed: "打开动态",
      emptyLatest: "还没有下葬。倒下球队的手续已经开放。",
    },
    teamCard: {
      earlyAdmission: "提前入住",
      eliminated: "已淘汰",
    ...
    create: {
      title: "立墓碑",
      description: "为世界杯出局球队创建可分享的殡仪馆墓碑。",
      loading: "正在加载葬礼手续...",
